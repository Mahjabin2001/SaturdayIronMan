		...
		/*
		 ...
		 java.util.Collection (i)
		 		...
		 		Set (i)
		 				HashSet -> linked HashSet
		 					...
		 					HashSet: Hash set store unordered collection containing unique value
		 		...
		 		List (i) -> 
		 				...
		 				LinkedList
		 					...
		 					ArrayList: The ArrayList class is a re sizable array
		 ...
		 java.util.Map (i)
		 		...
		 		Sorted Map (i)-> Navigable Map (i) -> Tree Map
		 					...
		 					Hash Map: Hash map store multiple data using key-value pair, hash map is synchronized, not thread-safe
		 					Linked HashMap: Provides a way to order and trace the elements
		 					Hash Table: Hash table is not synchronized, thread safe
